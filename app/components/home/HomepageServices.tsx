...
const SERVICES = [
  ...
  },
  {
    ...
    description: 'Analyse approfondie de vos performances LinkedIn. Tableaux de bord, KPIs et insights actionnables pour piloter votre stratégie avec la data.',
  ...
  },
  {
    ...
    description: "Des guides pratiques et actionnables pour maîtriser LinkedIn à votre rythme. Prospection, contenu, copywriting, algorithme — méthodes testées sur le terrain.",
  ...
  },
  {
    ...
    badge: 'Présentiel',
    badgeStyle: { backgroundColor: 'rgba(51,87,167,0.15)', color: '#6681bd', borderColor: 'rgba(51,87,167,0.3)' },
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 rounded-3xl pointer-events-none"
                    style={{ background: `radial-gradient(circle at 30% 30%, rgba(${service.accentRgb},0.06) 0%, transparent 70%)` }} />

                  {/* Bordure glow hover */}
                  <div className="absolute inset-0 rounded-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none"
                    style={{ boxShadow: `0 0 0 1.5px rgba(${service.accentRgb},0.35), 0 0 30px rgba(${service.accentRgb},0.12)` }} />

                  <div className="relative z-10">
                    {/* Badge */}
                    <span className="inline-block border text-xs font-semibold px-3 py-1 rounded-full mb-5 uppercase tracking-wider"
                    ...
                    <motion.div
                      animate={{ y: [0, -6, 0] }}
                      transition={{ duration: service.floatDuration, delay: service.floatDelay, repeat: Infinity, ease: 'easeInOut' }}
                      ...
                      style={{
                        ...
                        boxShadow: `0 0 20px rgba(${service.accentRgb}, 0.12)`,
                      }}
                    >
