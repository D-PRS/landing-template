...
export const FAQ_ITEMS = [
  {
    question: 'À qui s\'adressent ces e-books ?',
    reponse: 'Nos e-books sont conçus pour les indépendants, dirigeants, commerciaux, recruteurs et toute personne souhaitant mieux exploiter LinkedIn, qu\'ils soient débutants ou déjà actifs sur la plateforme.',
  },
  {
    question: 'Les guides sont-ils vraiment applicables immédiatement ?',
    reponse: 'Oui. Chaque e-book est structuré autour d\'actions concrètes, avec des exemples et des méthodes testées sur le terrain. Vous pouvez commencer à appliquer dès la première lecture.',
  },
  {
    question: 'Puis-je bénéficier d\'un accompagnement personnalisé en plus des e-books ?',
    reponse: 'Absolument. En parallèle de nos guides, nous proposons des services d\'accompagnement LinkedIn sur mesure : optimisation de profil, coaching, création de contenu, et plus encore.',
  },
  {
    question: 'Comment fonctionne le paiement et la livraison ?',
    reponse: 'Après votre commande, vous recevez immédiatement le lien de téléchargement par e-mail. Les paiements sont sécurisés. Si vous avez un problème, notre équipe vous répond rapidement.',
  },
  {
    question: 'Les e-books sont-ils mis à jour ?',
    reponse: 'Oui. L\'algorithme LinkedIn et les bonnes pratiques évoluent constamment. Nous mettons à jour nos guides régulièrement pour refléter les dernières tendances et stratégies efficaces.',
  },
]
