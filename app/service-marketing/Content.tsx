        ...
        {AVANT_APRES.map((pair, i) => (
          ...
          >
            ...
            <div className="relative rounded-2xl overflow-hidden border border-white/10">
              ...
              <Image src={pair.avant} alt="Profil avant optimisation" width={600} height={400} className="w-full aspect-[3/2] object-cover lg:aspect-auto lg:h-auto lg:object-contain" unoptimized />
            </div>
            {/* Après */}
            <div className="relative rounded-2xl overflow-hidden border"
              ...
              <Image src={pair.apres} alt="Profil après optimisation" width={600} height={400} className="w-full aspect-[3/2] object-cover lg:aspect-auto lg:h-auto lg:object-contain" unoptimized />
            </div>
          </div>
        ))}
      </div>
